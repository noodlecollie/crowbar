...
Sets the pointer to this entry box's command suggestion list. 

\begin{DoxyWarning}{Warning}
Any previously held list is not deleted -\/ be sure to deallocate the old pointer first if necessary. 
\end{DoxyWarning}

\begin{DoxyParams}{Parameters}
{\em list} & List pointer to set. Returns the command suggestion list belonging to this entry box. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
